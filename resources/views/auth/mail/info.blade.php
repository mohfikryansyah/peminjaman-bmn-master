                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td class="logo" style="text-align: center;">
                                    <h1><a href="#">BPKHTL XV Gorontalo</a></h1>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
                                    <div class="text">
                                        <h2>Informasi Pengembalian Barang</h2>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: center;">
                                    <div class="text-author">
                                        <img src="{{ asset('storage/' . $infoMail['foto']) }}" alt=""
                                            style="width: 100px; max-width: 600px; height: auto; margin: auto; display: block;">
                                        <h3 class="name">{{ $infoMail['title'] }}</h3>
                                        <span class="position">{{ $infoMail['pangkat'] }}</span>
                                    </div>
                                </td>
                            </tr>
                        </table>
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    <td class="bg_light" style="text-align: center;">
                        <p style="color: rgba(255, 0, 0, 0.8);">Jatuh tempo pengembalian barang tersisa {{ $infoMail['selisih'] }} hari.</p>
                    </td>
                </tr>
            </table>
